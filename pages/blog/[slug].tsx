...
const BlogTemplate: NextPage<IBlogTemplateProps> = ({
  markdownFile,
  title,
}) => {
  const formOptions = {
    fields: [
      {
        ...
        parse: (filename: String) => `../static/${filename}`,

        // Decide the file upload directory for the post
        uploadDir: () => '/src/public/static/',

        // Generate the src attribute for the preview image.
        previewSrc: (data: any) => `/static/${data.frontmatter.hero_image}`,
      },
      {
...
BlogTemplate.getInitialProps = async function (ctx: NextPageContext) {
